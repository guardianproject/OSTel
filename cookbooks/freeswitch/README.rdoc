...
This cookbook will compile, install and configure Freeswitch to be an OSTN
compliant SIP registrar and ZRTP media proxy. All signalling is encrypted and if
